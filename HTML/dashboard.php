        ...
        <div class="nav-container">
            ...
            <div class="nav-user">
                ...
                <div class="dropdown-menu" id="dropdownMenu">
                    ...
                    <a href="../HTML/login.html" class="dropdown-item logout">Logout</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <section class="profile-section">
        <div class="profile-container row-layout">
            <div class="profile-photo-wrapper">
                ...
                <label for="profilePhotoInput" class="edit-photo-btn" title="Edit Photo">
                    <span>✏️</span>
                </label>
        ...
        <div class="dashboard-container">
            ...
            <section class="quick-actions">
                ...
                <div class="action-buttons">
                    <button class="action-btn primary" id="createPostBtn">
